...
# Install emacs and give me a handy alias for TGIK
echo "alias iptables-list-all='iptables -vL -t filter && iptables -vL -t nat && iptables -vL -t mangle && iptables -vL -t raw && iptables -vL -t security'" >> ~/.bash_profile
...
# Commenting out so we can explore a cluster without calico
#
#
# Note: We hack in here for TGIK and to install calico just copy/paste the commented out command
#
#
